...
steps['JpsiMuMu_Pt-8_13INPUT']={'INPUT':InputInfo(dataSet='/RelValJpsiMuMu_Pt-8_13/%s/GEN-SIM'%(baseDataSetRelease[13],),location='STD')}
...
steps['JpsiMuMu_Pt-8_13UP15INPUT']={'INPUT':InputInfo(dataSet='/RelValJpsiMuMu_Pt-8_13/%s/GEN-SIM'%(baseDataSetRelease[3],),location='STD')}
# new BPH relvals produced for the first time in 810_pre9
