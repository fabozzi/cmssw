...
#                             '--conditions'  : 'auto:run2_mc',
                             '--conditions'  : '80X_mcRun2_asymptotic_2016_TrancheIV_v8_width9p9mum',
                             '--beamspot'    : 'Realistic25ns13TeV2016Collision',
                             '--customise_commands'    : '"process.VtxSmeared.Emittance = cms.double(4.618e-8)\\n process.VtxSmeared.SigmaZ = cms.double(3.201970)\\n process.VtxSmeared.X0 = cms.double(0.0856765)\\n process.VtxSmeared.Y0 = cms.double(0.1772797)\\n process.VtxSmeared.Z0 = cms.double(0.891892)\\n" ',
                             '--datatier'    : 'GEN-SIM',
...
steps['QCD_Pt_80_120_13']=gen2015('QCD_Pt_80_120_13TeV_TuneCUETP8M1_cfi',Kby(30,100))
...
steps['NuGun_UP15']=gen2015('SingleNuE10_cfi.py',Kby(30,100))
...
steps['TTbar_13']=gen2015('TTbar_13TeV_TuneCUETP8M1_cfi',Kby(30,100))
...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_8_0_26-80X_mcRun2_asymptotic_2016_TrancheIV_v8_width9p9mum_BS9p9-v1',         # 3 - 13 TeV samples with GEN-SIM from 750_p4; also GEN-SIM-DIGI-RAW-HLTDEBUG for id tests
...
#PU25={'-n':10,'--pileup':'AVE_10_BX_25ns','--pileup_input':'das:/RelValMinBias_13/%s/GEN-SIM'%(baseDataSetRelease[3],)}
PU25={'-n':10,'--pileup':'AVE_30_BX_25ns','--pileup_input':'das:/RelValMinBias_13/%s/GEN-SIM'%(baseDataSetRelease[3],)}
