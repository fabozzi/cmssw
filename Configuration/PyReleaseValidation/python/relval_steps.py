...
baseDataSetRelease=[
    'CMSSW_7_1_0_pre5-START71_V1-v1',  # 8 TeV relval
...
steps['Pythia6_BuJpsiK_TuneZ2star_13INPUT']={'INPUT':InputInfo(dataSet='/RelValPythia6_BuJpsiK_TuneZ2star_13/%s/GEN-SIM'%(baseDataSetRelease[0],),location='STD')} 
