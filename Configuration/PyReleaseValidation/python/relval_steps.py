...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_8_1_0_pre15-PU25ns_81X_mcRun2_asymptotic_v11_hipM17-v1',     # 5 - fullSim PU 25ns premix for 810pre4
...
PU25={'-n':10,'--pileup':'2016_25ns_Moriond17MC_PoissonOOTPU','--pileup_input':'das:/RelValMinBias_13/%s/GEN-SIM'%(baseDataSetRelease[3],)}
